  ...
  return (
    <div className="flex max-w-2xl mx-auto pl-10">
      <section className="w-full max-w-2xl my-10">
        ...
        <div className="flex items-center justify-between bg-[#e7e5e5] p-5 rounded-2xl">
        ...
        <div className="flex justify-end mt-5">
          {loading ? (
            ...
            <Button onClick={editProfileHandler} className="w-fit bg-blue-500 hover:bg-blue-600 cursor-pointer">
              Submit
            </Button>
          )}
        </div>
